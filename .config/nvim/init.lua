...
require("lazy").setup({
  ...
  { 
    ...
    build = function() vim.fn.system("cd " .. vim.fn.stdpath("data") .. "/lazy/markdown-preview.nvim/app && npm install") end,
    ft = { "markdown" }
  },
...
-- Apply winfixheight and winfixwidth to all existing windows at startup
for _, win in ipairs(vim.api.nvim_list_wins()) do
    vim.api.nvim_win_set_option(win, "winfixheight", true)
    vim.api.nvim_win_set_option(win, "winfixwidth", true)
end

-- Automatically apply winfixheight and winfixwidth to new windows
